...
function StatisticsController(options) {
       ...
       this.node.services.ravend.on('tip', this._rapidProtectedUpdateTip.bind(this));
...
StatisticsController.prototype.totalSupply = function(req, res) {
    ...
    var supply = (new BigNumber(0)).plus((this.node.services.ravend.height) * 5000).toString(10);
...
StatisticsController.prototype.getBlockReward = function(height) {
