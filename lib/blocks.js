...
if ( height < 77777 ) subsidy *= 21000 ;
    else if ( height < 97777 ) subsidy *= 20000; //+20k blocks
    else if ( height < 117777 ) subsidy *= 19000;
    else if ( height < 137777 ) subsidy *= 18000;
    else if ( height < 157777 ) subsidy *= 17000;
    else if ( height < 177777 ) subsidy *= 16000;
    else if ( height < 197777 ) subsidy *= 15000;
    else if ( height < 217777 ) subsidy *= 14000;
    else if ( height < 257777 ) subsidy *= 12000;
    else if ( height < 237777 ) subsidy *= 13000;
    else if ( height < 277777 ) subsidy *= 11000;
    else if ( height < 297777 ) subsidy *= 10000;
    else if ( height < 317777 ) subsidy *= 9000;
    else if ( height < 337777 ) subsidy *= 8000;
    else if ( height < 367777 ) subsidy *= 7000; //+30k blocks
    else if ( height < 417777 ) subsidy *= 6000; //+50k blocks
    else if ( height < 467777 ) subsidy *= 5000;
    else if ( height < 517777 ) subsidy *= 4000;
    else if ( height < 567777 ) subsidy *= 3000;
    else if ( height < 617777 ) subsidy *= 2000;
    else if ( height < 667777 ) subsidy *= 1000;
    else if ( height < 717777 ) subsidy *= 900;
    else if ( height < 777777 ) subsidy *= 777;
    else if ( height < 817777 ) subsidy *= 700;
    else if ( height < 867777 ) subsidy *= 600;
    else if ( height < 917777 ) subsidy *= 500;
    else if ( height < 967777 ) subsidy *= 400;
    else if ( height < 1017777 ) subsidy *= 300;
    else if ( height < 1067777 ) subsidy *= 200;
    else if ( height < 1117777 ) subsidy *= 100;
    else if ( height < 1167777 ) subsidy *= 77;
    else if ( height < 1217777 ) subsidy *= 47;
    else if ( height < 1267777 ) subsidy *= 37;
    else if ( height < 1317777 ) subsidy *= 27;
    else if ( height < 1367777 ) subsidy *= 17;
    else {
        var halvings = Math.floor((height - 1367777) /2102400);
